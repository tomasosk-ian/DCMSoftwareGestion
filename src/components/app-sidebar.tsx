...
function Item({ text, url }: { text: string, url: string }) {
  return <ul className="main-nav outside-item-remove-margin">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Item text={t("home")} url="https://lockersurbanos.com.ar/"/>
            </SidebarMenuButton>
            <SidebarMenuButton asChild>
              <Item text={t("lockers")} url="https://lockersurbanos.com.ar/#!/lockers"/>
            </SidebarMenuButton>
            <SidebarMenuButton asChild>
              <Item text={t("faq")} url="https://lockersurbanos.com.ar/preguntas-frecuentes/"/>
            </SidebarMenuButton>
            <SidebarMenuButton asChild>
              <Item text={t("contact")} url="https://lockersurbanos.com.ar/contacto/"/>
            </SidebarMenuButton>
            <SidebarMenuButton asChild>
              <div className="w-[80%] justify-self-center mt-8">
                <Select
                  defaultValue={lang}
